...
var _deepEqualJson = _interopRequireDefault(require("deep-equal-json"));
...
var elementAXObjectMap = {
  ...
  get: function get(key) {
    var item = elementAXObjects.find(function (tuple) {
      return key.name === tuple[0].name && (0, _deepEqualJson.default)(key.attributes, tuple[0].attributes);
    });
    return item && item[1];
  },
