import { HexString, IProgramCreateResult, IProgramUploadResult, V1000ProgramCreateOptions, V1000ProgramUploadOptions } from '../../types';
...
export declare class V1000Program extends GearProgram {
    ...
    upload(args: V1000ProgramUploadOptions, metaOrHexRegistry?: ProgramMetadata | HexString, typeName?: string): IProgramUploadResult;
    ...
    create(args: V1000ProgramCreateOptions, metaOrHexRegistry?: ProgramMetadata | `0x${string}`, typeName?: string | number): IProgramCreateResult;
}
