...
import { GearCoreIdsCodeId, GearCoreIdsMessageId, GearCoreIdsProgramId, PalletGearVoucherInternalPrepaidCall, PalletGearVoucherInternalVoucherId } from '../lookup';
...
declare module '@polkadot/api-base/types/submittable' {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        gear: {
             ...
             **/
            createProgram: AugmentedSubmittable<(codeId: GearCoreIdsCodeId | string | Uint8Array, salt: Bytes | string | Uint8Array, initPayload: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsCodeId,
                Bytes,
                Bytes,
                u64,
             ...
             **/
            resumeSessionCommit: AugmentedSubmittable<(sessionId: u32 | AnyNumber | Uint8Array, blockCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u32,
                u32
            ]>;
            /**
             ...
             **/
            sendMessage: AugmentedSubmittable<(destination: GearCoreIdsProgramId | string | Uint8Array, payload: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsProgramId,
                Bytes,
                u64,
                u128,
             ...
             * or reply on the message from mailbox.
             **/
            sendReply: AugmentedSubmittable<(replyToId: GearCoreIdsMessageId | string | Uint8Array, payload: Bytes | string | Uint8Array, gasLimit: u64 | AnyNumber | Uint8Array, value: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                GearCoreIdsMessageId,
                Bytes,
                u64,
                u128,
        ...
        gearVoucher: {
            ...
            issue: AugmentedSubmittable<(spender: AccountId32 | string | Uint8Array, balance: u128 | AnyNumber | Uint8Array, programs: Option<BTreeSet<GearCoreIdsProgramId>> | null | Uint8Array | BTreeSet<GearCoreIdsProgramId> | string[], codeUploading: bool | boolean | Uint8Array, duration: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                AccountId32,
                u128,
            ...
            update: AugmentedSubmittable<(spender: AccountId32 | string | Uint8Array, voucherId: PalletGearVoucherInternalVoucherId | string | Uint8Array, moveOwnership: Option<AccountId32> | null | Uint8Array | AccountId32 | string, balanceTopUp: Option<u128> | null | Uint8Array | u128 | AnyNumber, appendPrograms: Option<Option<BTreeSet<GearCoreIdsProgramId>>> | null | Uint8Array | Option<BTreeSet<GearCoreIdsProgramId>> | BTreeSet<GearCoreIdsProgramId> | (string | Uint8Array)[], codeUploading: Option<bool> | null | Uint8Array | bool | boolean, prolongDuration: Option<u32> | null | Uint8Array | u32 | AnyNumber) => SubmittableExtrinsic<ApiType>, [
                AccountId32,
                PalletGearVoucherInternalVoucherId,
                Option<AccountId32>,
                Option<u128>,
