...
export declare class GearGas {
     ...
     * ```
     */
    initUpload(sourceId: HexString, code: HexString | Buffer | Uint8Array, payload: PayloadType, value?: Value, allowOtherPanics?: boolean, meta?: ProgramMetadata, typeIndexOrTypeName?: number | string): Promise<GasInfo>;
    /**
